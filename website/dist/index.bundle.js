...
module.exports = __webpack_require__.p + "images/default-d6f26a302e48fa49538037b52ce58456.jpg";
...
var ImageMemory = exports.ImageMemory = function () {
    function ImageMemory(image_data) {
    ...
    _createClass(ImageMemory, [{
        ...
        value: function get_image_data() {
            ...
            var img_array = new Uint8ClampedArray(Module.HEAPU8.buffer, this.ptr, this.byte_count);
...
var _kmeans = __webpack_require__(12);
...
var JsKmeansPainter = exports.JsKmeansPainter = function () {
    function JsKmeansPainter(k, image_memory) {
        ...
        for (var i = 0; i < this.image_array.length; i += 4) {
    ...
    _createClass(JsKmeansPainter, [{
        ...
        value: function step(steps) {
            ...
            this.observations.forEach(function (o, i) {
                ...
                _this.image_array[i * 4] = color[0];
                _this.image_array[i * 4 + 1] = color[1];
                _this.image_array[i * 4 + 2] = color[2];
            });
        }
    }, {
        key: "free",
...
var _image_memory = __webpack_require__(5);

var _js_kmeans_painter = __webpack_require__(6);

var _asmjs_kmeans_painter = __webpack_require__(4);
...
var paint_canvas = function paint_canvas(painter, steps, image_memory, canvas) {
    ...
    if (steps > 0 && !STOP) {
        ...
        setTimeout(function () {
            return paint_canvas(painter, steps - 1, image_memory, canvas, times);
        }, 10);
    } else {
        STOP = false;
...
(0, _jquery2.default)(document).ready(function () {
    ...
    filepath2image_data(_default2.default).then(function (default_image_data) {
        var image_memory = null;
        ...
        var new_image = function new_image(new_image_data) {
            ...
            image_memory = new _image_memory.ImageMemory(new_image_data);
            draw_image_data(image_memory.get_image_data(), canvas);
        };
